...
// let leftArrow = document.getElementById("leftArrow");
// let imgNoruegaCamry = document.getElementsBy("imgcanada");
// let imgNoruegaPlaya = document.getElementById("imgcanada2");
// let imgNoruegaRav4 = document.getElementById("imgcanada3");

// leftArrow.addEventListener("click", function(){
//     if (imgNoruegaCamry.classlist.contains("canada1-camry")){
//         imgNoruegaCamry.classlist.remove("canada1-camry");
//         imgNoruegaCamry.classlist.add("canada-camry-hidden");
//         imgNoruegaPlaya.classlist.add("canada2-camry");
